"""
Django settings for table_extraction project.
...
SECRET_KEY = 'django-insecure-u&kkq6(a*2mn*fdh6vyk5f#(m+wf7@ruab9(8uk3_wavc+3+u)'
...
WSGI_APPLICATION = 'table_extraction.wsgi.application'
